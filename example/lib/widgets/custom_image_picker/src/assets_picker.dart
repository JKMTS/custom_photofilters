...
import 'package:photofilters_example/widgets/custom_image_picker/src/widget/insta_asset_picker_delegate.dart';
  ...
  Future<List<AssetEntity>?> restorableAssetsPicker(
    ...
    builder ??= InstaAssetPickerBuilder(
        ...
        pickerTheme: pickerTheme ??
            AssetPicker.themeData(Theme.of(context).primaryColor),
